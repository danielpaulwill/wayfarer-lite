...
function ChooseYourCharacter({ handleOnChange, handleOnClick, onCharacterConfirm }) {
...
// I need to do a fetch request to grab these images from the server.
// I also need to create a "character_avatar" resource on my database (get only).
