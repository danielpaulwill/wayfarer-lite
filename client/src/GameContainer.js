...
function GameContainer() {
  ...
  const [professionSelect, setProfessionSelect] = useState(true)

  const gameStart = <GameStart handleClick={handleStartClick} />
  const chooseYourCharacter = <ChooseYourCharacter handleOnChange={handleNameChange} handleOnClick={handleAvatarClick} onCharacterConfirm={handleCharacterConfirm} professionClick={handleProfessionClick} professionSelect={professionSelect} />
  ...
  function handleCharacterConfirm(e) {
    ...
    setCurrentPage(chooseYourItems)
  }

  console.log({ professionSelect })
  
  function handleProfessionClick() {
    setProfessionSelect(professionSelect => !professionSelect)
  }
